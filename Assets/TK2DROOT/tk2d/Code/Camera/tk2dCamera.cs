...
public class tk2dCamera : MonoBehaviour 
{
	...
	public void UpdateCameraMatrix()
	{
		...
		if (inheritedCameraSettings.projection == tk2dCameraSettings.ProjectionType.Perspective) {
			...
			if (unityCamera.transparencySortMode != inheritedCameraSettings.transparencySortMode) unityCamera.transparencySortMode = inheritedCameraSettings.transparencySortMode;
			...
			if (unityCamera.transparencySortMode != TransparencySortMode.Orthographic) unityCamera.transparencySortMode = TransparencySortMode.Orthographic;

...
class tk2dTextMeshEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
		...
		if (allFonts != null)
        {
			...
			int newRenderLayer = EditorGUILayout.IntField("Render Layer", textMesh.RenderLayer);
			if (newRenderLayer != textMesh.RenderLayer) { UndoableAction( tm => tm.RenderLayer = newRenderLayer ); }
